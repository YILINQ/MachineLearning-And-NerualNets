...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        self.deconv1 = deconv(noise_size, conv_dim*2, 4, padding=0)
        self.deconv2 = deconv(conv_dim*2, conv_dim, 4)
        self.deconv3 = deconv(conv_dim, conv_dim//2, 4)
        self.deconv4 = deconv(conv_dim//2, 3, 4, batch_norm=False)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv4 = conv(conv_dim*2, 1, 4, padding=0, batch_norm=False)
